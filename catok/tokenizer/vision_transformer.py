...
from catok.tokenizer.fused_attention import Attention

__all__ = ['VisionTransformer', 'vit_tiny_patch16', 'vit_small_patch16',
           'vit_base_patch16', 'vit_large_patch16', 'vit_huge_patch14', 'vit_base_patch8']
...
class VisionTransformer(nn.Module):
    ...
    def prepare_tokens(self, x, use_ibot=False):
        B, nc, w, h = x.shape
    ...
    def forward(self, x, is_causal=True, use_dist=False):
        ...
        cls_token = x[:, 0]
        patch_tokens = x[:, 1:-self.num_slots]
        if use_dist:
            return cls_token, patch_tokens, outcome
        return outcome
